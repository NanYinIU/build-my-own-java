...
package com.nanyin.springboot.hippo4j.nacos.config;
...
public class DynamicThreadPoolConfig {
    ...
    @Bean(name = "messageConsumeTtlDynamicThreadPool")
    @DynamicThreadPool
    public Executor messageConsumeTtlDynamicThreadPool() {
        String threadPoolId = "message-consume";
        ThreadPoolExecutor customExecutor = ThreadPoolBuilder.buildDynamicPoolById(threadPoolId);
...
//        Executor ttlExecutor = TtlExecutors.getTtlExecutor(customExecutor);
    ...
    public ThreadPoolExecutor messageProduceDynamicThreadPool() {
        return ThreadPoolBuilder.buildDynamicPoolById("message-consume");
    }
}
